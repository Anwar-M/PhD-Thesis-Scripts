function main_spectrumlevel_sparker
close all;
save_data = 0;

main_path = 'O:\APIAN\APIAN Pylon Processed\Sparker\';
addpath('O:\MATLAB Signal Processing Files');
mainresultpath = 'O:\PhD Thesis\RESULTS\CH5\SPARKER';

dirdata{1} = '2014-09-26_08-57-01';
dirdata{2} = '2014-09-26_09-52-50';
dirdata{3} = '2014-09-30_18-38-26';
...
line([1.5;1.5],[0;58.92], 'Color', 'k', 'LineStyle', '--', 'LineWidth', 1);
% line(2*sqrt(2)*[1;1],[0;100], 'Color', 'k', 'LineStyle', '--', 'LineWidth', 1);

hl = legend('On, no flow', 'On, $U$ = 60 [m/s]', 'Off, $U$ = 60 [m/s]', 'Location', 'NorthEast');
set(hl, 'Interpreter', 'LaTex');
plot_settings_font(gca, '$f$ [kHz]', 'Spectrum Level [dB]', [], [-0.5 25], [0 100], ...
    0:5:25e0, 0:20:100, 20, 'on', 'on', 0, 0, [], save_data, ...
    [mainresultpath '\SPECTRUMLEVEL_SP']);
hold off
