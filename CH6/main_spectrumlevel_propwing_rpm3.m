function main_spectrumlevel_propwing_rpm3
save_data = 0*1;
include_background = 1;
addpath('O:\MATLAB Signal Processing Files');

datafile1 = 'O:\V-Tunnel 12-12 Wing-Prop\Data MAT\Meas5.mat';
datafile2 = 'O:\V-Tunnel 12-12 Wing-Prop\Data MAT\Meas6.mat';
datafile3 = 'O:\V-Tunnel 12-12 Wing-Prop\Data MAT\Meas9.mat';

datafile4 = 'O:\V-Tunnel 22-05-2018 Wing-Prop Wind\Data MAT\Meas5.mat';
datafile5 = 'O:\V-Tunnel 22-05-2018 Wing-Prop Wind\Data MAT\Meas6.mat';
datafile6 = 'O:\V-Tunnel 22-05-2018 Wing-Prop Wind\Data MAT\Meas9.mat';
...
plot_settings_font(gca, '$f$ [kHz]', 'Spectrum Level [dB]', ['RPM = 7600 [min$^{-1}$]'], [0 10], [10 75], ...
    0:5:25e0, 0:10:80, 20, 'on', 'on', 0, 0, [], save_data, ...
    [mainresultpath '\SPECTRUMLEVEL_ARRAY_RPM3']);
