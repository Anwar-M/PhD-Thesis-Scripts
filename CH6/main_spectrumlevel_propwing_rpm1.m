function main_spectrumlevel_propwing_rpm1
save_data = 1;
include_background = 1;
addpath('O:\MATLAB Signal Processing Files');

datafile1 = 'O:\V-Tunnel 12-12 Wing-Prop\Data MAT\Meas1.mat';
datafile2 = 'O:\V-Tunnel 12-12 Wing-Prop\Data MAT\Meas2.mat';
datafile3 = 'O:\V-Tunnel 12-12 Wing-Prop\Data MAT\Meas7.mat';

datafile4 = 'O:\V-Tunnel 22-05-2018 Wing-Prop Wind\Data MAT\Meas1.mat';
datafile5 = 'O:\V-Tunnel 22-05-2018 Wing-Prop Wind\Data MAT\Meas2.mat';
datafile6 = 'O:\V-Tunnel 22-05-2018 Wing-Prop Wind\Data MAT\Meas7.mat';
...
plot_settings_font(gca, '$f$ [kHz]', 'Spectrum Level [dB]', ['RPM = 4400 [min$^{-1}$]'], [0 25], [10 75], ...
    0:5:25e0, 0:10:70, 20, 'on', 'on', 0, 0, [], save_data, ...
    [mainresultpath '\SPECTRUMLEVEL_ARRAY_RPM1']);
