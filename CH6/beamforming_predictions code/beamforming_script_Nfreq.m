...
% [x, y, A] = CleanSC(CSM, z, freq(1:end-1),[xmin xmax ymin ymax], reso, mic_config.', c);
[x, y, A] = adaptive_HR_CleanSC_mod(CSM, z, freq(1:end-1),[xmin xmax ymin ymax], reso, mic_config.', c, 2);
%nu = 3;
%[x, y, A] = FastBeamformingFunc(CSM, z, freq(1:end-1),[xmin xmax ymin ymax], reso, mic_config.', c, nu);
