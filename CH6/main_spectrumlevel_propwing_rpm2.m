function main_spectrumlevel_propwing_rpm2
save_data = 1;
include_background = 1;
addpath('O:\MATLAB Signal Processing Files');

datafile1 = 'O:\V-Tunnel 12-12 Wing-Prop\Data MAT\Meas3.mat';
datafile2 = 'O:\V-Tunnel 12-12 Wing-Prop\Data MAT\Meas4.mat';
datafile3 = 'O:\V-Tunnel 12-12 Wing-Prop\Data MAT\Meas8.mat';

datafile4 = 'O:\V-Tunnel 22-05-2018 Wing-Prop Wind\Data MAT\Meas3.mat';
datafile5 = 'O:\V-Tunnel 22-05-2018 Wing-Prop Wind\Data MAT\Meas4.mat';
datafile6 = 'O:\V-Tunnel 22-05-2018 Wing-Prop Wind\Data MAT\Meas8.mat';
...
h2 = plot(f2/1000, sl2, 'LineWidth', 1, 'Color', [0.8500, 0.3250, 0.0980]);
h3 = plot(f3/1000, sl3, 'LineWidth', 1, 'Color', [0.4940, 0.1840, 0.5560]);
h4 = plot(f4/1000, sl4, 'LineWidth', 1, 'Color', [0, 0.4470, 0.7410], 'LineStyle', '--');
h5 = plot(f5/1000, sl5, 'LineWidth', 1, 'Color', [0.8500, 0.3250, 0.0980], 'LineStyle', '--');
h6 = plot(f6/1000, sl6, 'LineWidth', 1, 'Color', [0.4940, 0.1840, 0.5560], 'LineStyle', '--');

if include_background&&exist(backgroundfile,'file')
    h7 = plot(fb/1000, slb, 'LineWidth', 1, 'Color', [0.4660, 0.6740, 0.1880]);
    hl = legend([h1 h2 h3], 'Propeller only', '$d_{\mathrm{object}}$ = 0.39 [m]', '$d_{\mathrm{object}}$ = 0.54 [m]', 'Location', 'NorthEast');
    set(hl, 'Interpreter', 'LaTex');
else
    hl = legend('Source only', '$d_{\mathrm{object}}$ = 0.63 [m]', '$d_{\mathrm{object}}$ = 0.24 [m]', 'Location', 'NorthEast');
    set(hl, 'Interpreter', 'LaTex');
end

hold off

plot_settings_font(gca, '$f$ [kHz]', 'Spectrum Level [dB]', ['RPM = 7000 [min$^{-1}$]'], [0 25], [10 75], ...
    0:5:25e0, 0:10:80, 20, 'on', 'on', 0, 0, [], save_data, ...
    [mainresultpath '\SPECTRUMLEVEL_ARRAY_RPM2']);
