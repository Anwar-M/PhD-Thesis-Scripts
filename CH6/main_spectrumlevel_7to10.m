function main_spectrumlevel_7to10
save_data = 1;
include_background = 1;
addpath('O:\MATLAB Signal Processing Files');

datafile1 = 'O:\V-Tunnel 30-10 Plate-Source\Data MAT\Mes10.mat';
datafile2 = 'O:\V-Tunnel 30-10 Plate-Source\Data MAT\Mes7.mat';
datafile3 = 'O:\V-Tunnel 30-10 Plate-Source\Data MAT\Mes9.mat';
...
if include_background&&exist(backgroundfile,'file')
    ...
    hl = legend('Source only', '$d_{\mathrm{object}}$ = 0.7 [m]', '$d_{\mathrm{object}}$ = 0.22 [m]', 'Background', 'Location', 'NorthEast');
    set(hl, 'Interpreter', 'LaTex');
else
    hl = legend('Source only', '$d_{\mathrm{object}}$ = 0.7 [m]', '$d_{\mathrm{object}}$ = 0.22 [m]', 'Location', 'NorthEast');
    set(hl, 'Interpreter', 'LaTex');
end

hold off

plot_settings_font(gca, '$f$ [kHz]', 'Spectrum Level [dB]', ['$d_{\mathrm{array}}$ = 2.57 [m]'], [0 25], [0 50], ...
    0:5:25e0, 0:10:60, 20, 'on', 'on', 0, 0, [], save_data, ...
    [mainresultpath '\SPECTRUMLEVEL_ARRAY_7TO10']);
