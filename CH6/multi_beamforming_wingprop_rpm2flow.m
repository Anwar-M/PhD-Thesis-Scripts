function multi_beamforming_wingprop_rpm2flow
% close all;
save_data = 1;
remdiag = 1;
...
file_path1 = ['O:\V-Tunnel 22-05-2018 Wing-Prop Wind\Data MAT\Meas4.mat'];
file_path2 = ['O:\V-Tunnel 22-05-2018 Wing-Prop Wind\Data MAT\Meas3.mat'];
save_path = [];
...
plot_settings(gca, '$x$ [m]', '$y$ [m]', ['Flow'], ...
    [xmin xmax], [ymin ymax], [-0.8 -0.4 0 0.4 0.8], [-0.9 -0.6 -0.3 0 0.3 0.6], ...
    'on', 'on', 1, [1 46 62], ...
    '$L_{\mathrm{p}}$ [dB]', save_data, [mainresultpath '\CBFLOW_1-25KHZ_PROPWINGRPM2']);
...
plot_settings(gca, '$x$ [m]', '$y$ [m]', ['Flow'], ...
    [xmin xmax], [ymin ymax], [-0.8 -0.4 0 0.4 0.8], [-0.9 -0.6 -0.3 0 0.3 0.6], ...
    'on', 'on', 1, [1 46 62], ...
    '$L_{\mathrm{p}}$ [dB]', save_data, [mainresultpath '\CBFLOW_1-25KHZ_PROPRPM2']);
