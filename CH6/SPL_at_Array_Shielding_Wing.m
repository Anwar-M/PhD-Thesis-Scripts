function SPL_at_Array_Shielding_Wing
close all;
save_data = 1;
mainresultpath = 'O:\PhD Thesis\RESULTS\CH6\SOURCEWING_SCATTER';

addpath('O:\MATLAB Signal Processing Files');

maindatapath = 'O:\V-Tunnel 20-11 Wing-Source\Data MAT';
load([maindatapath '\..\mic_poses_optim.mat']);

fileshields = {'Meas03.mat';'Meas03.mat';'Meas03.mat';...
               'Meas16.mat';'Meas16.mat';'Meas16.mat';'Meas03.mat';'Meas16.mat'};
filesources = {'Meas05.mat';'Meas05.mat';'Meas05.mat';...
               'Meas15.mat';'Meas15.mat';'Meas15.mat';'Meas05.mat';'Meas15.mat'};
filecomps = {'Meas3_2000.dat';'Meas3_4000.dat';'Meas3_5000.dat';...
             'Meas16_2000.dat';'Meas16_4000.dat';'Meas16_5000.dat';'Meas3_OSPL.dat';'Meas16_OSPL.dat'};
fcs = [2000; 4000; 5000; 2000; 4000; 5000];
dBranges = [0 6; 0 10; 0 10; 0 6; 0 10; 0 10; 0 5; 0 5];
...
fid = fopen(['K:\co\ance\ance-ShieldingComparison\Results\wing_source_results\comp data files\' filecomp]);
fgets(fid);
