function multi_beamforming_wingprop_rpm3
% close all;
save_data = 1;
remdiag = 1;
...
plot_settings_font(gca, '$x$ [m]', '$y$ [m]', ['No flow'], ...
    [xmin xmax], [ymin ymax], [-0.8 -0.4 0 0.4 0.8], [-0.9 -0.6 -0.3 0 0.3 0.6], ...
    16, 'on', 'on', 1, [1 48:3:66], ...
    '$L_{\mathrm{p}}$ [dB]', save_data, [mainresultpath '\CBF_1-25KHZ_PROPWINGRPM3']);
...
plot_settings_font(gca, '$x$ [m]', '$y$ [m]', ['No flow'], ...
    [xmin xmax], [ymin ymax], [-0.8 -0.4 0 0.4 0.8], [-0.9 -0.6 -0.3 0 0.3 0.6], ...
    16, 'on', 'on', 1, [1 48:3:66], ...
    '$L_{\mathrm{p}}$ [dB]', save_data, [mainresultpath '\CBF_1-25KHZ_PROPRPM3']);
