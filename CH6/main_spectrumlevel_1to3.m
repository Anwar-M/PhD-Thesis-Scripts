function main_spectrumlevel_1to3
save_data = 1;
include_background = 1;
addpath('O:\MATLAB Signal Processing Files');

datafile1 = 'O:\V-Tunnel 30-10 Plate-Source\Data MAT\Mes3.mat';
datafile2 = 'O:\V-Tunnel 30-10 Plate-Source\Data MAT\Mes1.mat';
datafile3 = 'O:\V-Tunnel 30-10 Plate-Source\Data MAT\Mes2.mat';
...
if include_background&&exist(backgroundfile,'file')
    ...
    hl = legend('Source only', '$d_{\mathrm{object}}$ = 0.39 [m]', '$d_{\mathrm{object}}$ = 0.54 [m]', 'Background', 'Location', 'NorthEast');
    set(hl, 'Interpreter', 'LaTex');
else
    hl = legend('Source only', '$d_{\mathrm{object}}$ = 0.39 [m]', '$d_{\mathrm{object}}$ = 0.54 [m]', 'Location', 'NorthEast');
    set(hl, 'Interpreter', 'LaTex');
end

hold off

plot_settings_font(gca, '$f$ [kHz]', 'Spectrum Level [dB]', ['$d_{\mathrm{array}}$ = 1.72 [m]'], [0 25], [0 50], ...
    0:5:25e0, 0:10:60, 20, 'on', 'on', 0, 0, [], save_data, ...
    [mainresultpath '\SPECTRUMLEVEL_ARRAY_1TO3']);
